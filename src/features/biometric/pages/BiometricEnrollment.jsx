...
const HARDWARE_TIMEOUT_MS = 15000;
...
export default function BiometricEnrollment() {
  ...
  const handleStartScan = async () => {
    ...
    try {
      ...
      // Device IP, Port and Finger Index are handled by backend defaults
      ...
      if (err.message === "SCAN_TIMEOUT") {
        setIsTimedOut(true);
        setErrorMessage(
          "Hardware operation timed out. Fingerprint was not captured on time.",
        );
      } else {
        setErrorMessage(
          err?.response?.data?.message ||
            err?.message ||
            "Enrollment failed. Please ensure the biometric device is connected.",
        );
      }
    }
  };
  ...
  return (
    <div className="row g-3 biometric-enrollment">
      ...
      {/* Right Column: Fingerprint Enrollment */}
      <div className="col-lg-7">
        <div className="card p-3 h-100 be-card">
          {/* Right Section Header */}
          <div className="department-content-header">
            <div>
              <h1>Fingerprint Enrollment Device</h1>

              <p>Register employee fingerprints using the biometric scanner.</p>
            </div>
          </div>
          ...
          {!selectedEmp ? (
            ...
            <div>
              ...
              <div className="be-target-banner mb-3">
                ...
                <Badge
                  variant={
                    selectedEmp.fingerprintRegistered ? "info" : "danger"
                  }
                >
              ...
              {/* Error Banner */}
              {errorMessage && !selectedEmp.fingerprintRegistered && (
                ...
                <div className="col-md-6 text-center">
                  ...
                  <div className="fw-bold mt-3" style={{ color: "#0A2647" }}>
                    {isScanning
                      ...
                      : activeStep === 4 || selectedEmp.fingerprintRegistered
                  ...
                  <div className="small text-muted">
                    {isScanning
                      ...
                      : activeStep === 4 || selectedEmp.fingerprintRegistered
                        ? "This employee's fingerprint has already been enrolled."
                        : isTimedOut
